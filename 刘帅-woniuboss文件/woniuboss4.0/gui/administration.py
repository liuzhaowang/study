...
class WoniuBoss:
    def __init__(self):
        ...
        time.sleep(2)
    def purchase(self):
        self.driver.find_element_by_link_text('行政综合').click()
        self.driver.find_element_by_link_text('采购登记').click()
        self.driver.find_element_by_css_selector('button.btn-padding:nth-child(1)').click()
        self.driver.find_element_by_css_selector('#addAss-form > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > select:nth-child(2)').send_keys('电脑')
