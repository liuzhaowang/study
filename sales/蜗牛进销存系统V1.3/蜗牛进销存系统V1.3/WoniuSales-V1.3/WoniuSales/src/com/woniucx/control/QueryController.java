...
public class QueryController extends Controller {
	...
	public void stored() {
		...
		sql += "group by s.barcode,s.goodssize order by storesumid";
	...
	public void notstored() {
		String sql = "select goodsid,batchname,goodsserial,goodsname,unitprice,quantity,createtime from goods where barcode='0'";
